...
// 示例 1： 
//
// 输入：status = [1,0,1,0], candies = [7,5,4,100], keys = [[],[],[1],[]], containe
//dBoxes = [[1,2],[3],[],[]], initialBoxes = [0]
//输出：16
//解释：
...
// 示例 3： 
//
// 输入：status = [1,1,1], candies = [100,1,100], keys = [[],[0,2],[]], containedBo
//xes = [[],[],[]], initialBoxes = [1]
//输出：1
// 
//
// 示例 4： 
//
// 输入：status = [1], candies = [100], keys = [[]], containedBoxes = [[]], initial
//Boxes = []
//输出：0
// 
//
